...
import { getOneVariableExpenseService } from "../../../../../src/modules/finance/variable-expenses/services/getOneVariableExpense.service.js";
...
vi.mock(
  "../../../../../src/modules/finance/variable-expenses/services/getOneVariableExpense.service.js",
);
...
describe("get one variable expense integration test", () => {
  (it("should return the expense for the user", async () => {
    vi.mocked(getOneVariableExpenseService).mockResolvedValue(mockExpenseDb);
    ...
    it("should return 400 when id is not an uuid", async () => {
      const response = await request(app).get("/finance/variable-expense/123");
  ...
  it("should return 404 when variable expense not found", async () => {
    vi.mocked(getOneVariableExpenseService).mockRejectedValue(
