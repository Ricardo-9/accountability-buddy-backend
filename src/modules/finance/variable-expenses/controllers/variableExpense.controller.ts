...
export const variableExpenseController = {
  ...
  async getVariableExpenses(req: Request, res: Response, next: NextFunction) {
    ...
    try {
      const variableExpenses = await variableExpenseService.getVariableExpenses(
        userId,
        filters,
      );
  ...
  async updateVariableExpense(req: Request, res: Response, next: NextFunction) {
    const userId = req.user!.id;
    const data = req.body;
  ...
  async deleteVariableExpense(req: Request, res: Response, next: NextFunction) {
    const userId = req.user!.id;
    const { id } = req.params as unknown as getVariableExpenseType;
    try {
