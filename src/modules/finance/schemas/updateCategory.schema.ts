...
export type updateFinancialCategoryBody = z.infer<typeof updateFinancialCategorySchema>["body"]
export type updatefinancialCategoryId = z.infer<typeof updateFinancialCategorySchema>["params"]