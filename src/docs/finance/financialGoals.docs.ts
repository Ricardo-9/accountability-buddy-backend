 ...
 *                                                  type: string
 *                                                  format: date-time
 *                                                  example: 2026-03-31T09:15:15.544Z
 *                                      newBalance:
 *                                          type: string
 *                                          nullable: true
 *                                          description: Updated account balance after goal update (decimal serialized as string)
 *                                          example: 2000
 *          400:
 *              description: Invalid data
 *          401:
 ...
 *              description: User does not have access to the FINANCES area
 *          404:
 *              description: Resource not found (account or category or goal)
 *          422:
 *              description: Insufficient balance to update goal
 *          429:
 *              description: Too many requests
 *          500:
 *              description: Internal server error   
